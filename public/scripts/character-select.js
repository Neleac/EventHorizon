AFRAME.registerComponent("character-select", {
      ...
      if (el.is("spectator")) {
        ...
        if (el.is("human")) {
          ...
          leftHand.setAttribute(
            "networked",
            "template",
            "#human-lefthand-template"
          );
          leftHandModel.setAttribute(
            "networked",
            "template",
            "#human-lh-template"
          );
          ...
          rightHand.setAttribute(
            "networked",
            "template",
            "#human-righthand-template"
          );
          rightHandModel.setAttribute(
            "networked",
            "template",
            "#human-rh-template"
          );
          ...
          magnetHand.setAttribute(
            "networked",
            "template",
            "#robot-righthandmagnet-template"
          );
  ...
  spawnHumanObjects: function() {
    ...
    iceSyringe.object3D.rotation.set(
    ...
    spring.setAttribute(
      "show-spring",
      "start: #green-wire-start; end: #green-wire-end"
    );
    ...
    spring.setAttribute(
      "show-spring",
      "start: #red-wire-start; end: #red-wire-end"
    );
    ...
    spring.setAttribute(
      "show-spring",
      "start: #blue-wire-start; end: #blue-wire-end"
    );
    ...
    spring.setAttribute(
      "show-spring",
      "start: #yellow-wire-start; end: #yellow-wire-end"
    );
    ...
    fireSyringe.object3D.rotation.set(
      THREE.Math.degToRad(90),
      THREE.Math.degToRad(30),
      0
    );
  ...
  spawnRobotObjects: function() {
    ...
    spring.setAttribute(
      "show-spring",
      "start: #tv-wire-start; end: #tv-wire-end"
    );
